      ...
      <div className="max-w-3xl w-full px-6 text-center space-y-10" >
        ...
        <div className="space-y-4">
          ...
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center gap-3">
            ...
            {isGuestInputOpen ? (<button onClick={OpenGuestsInput} className="bg-zinc-800 text-zinc-200 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-zinc-700">
              Ajustar Local/Data
          ...
          {isGuestInputOpen && (
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center gap-3">
              <div className="flex items-center gap-2 flex-1">
                ...
                <input type="text" placeholder="Quem estará na viagem?" className="bg-transparent text-lg placerholder-zinc-400 outline-none flex-1" />
              </div>
