            ...
            <div className="w-[640px] rounded-xl py-5 px-6  bg-zinc-900 space-y-5">
                ...
                <form className="space-y-3">
                    <div className="h-14 px-4 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2">
                        ...
                        <input type="text" name="tittle" placeholder="Qual a sua atividade" className="bg-transparent text-lg placerholder-zinc-400 outline-none flex-1 " />
                    </div>

                    <div className="flex items-center gap-2">
                        <div className="h-14 flex-1 px-4 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2">
                            <Calendar className="text-zinc-400 size-5" />
                            <input type="datetime-local" name="occurs-at" placeholder="Data e horário" className="bg-transparent text-lg placerholder-zinc-400 outline-none flex-1" />
                        </div>
